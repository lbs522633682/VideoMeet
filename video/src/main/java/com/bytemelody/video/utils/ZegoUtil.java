...
public class ZegoUtil {
    ...
    public static long getAppID() {
        String strAppID = PreferenceUtil.getInstance().getStringValue(PreferenceUtil.KEY_APP_ID, "");
        if (strAppID.equals("")){
    ...
    public static byte[] getAppSign() {
        String strAppSign = PreferenceUtil.getInstance().getStringValue(PreferenceUtil.KEY_APP_SIGN, "");
